...
Public Class CrySalSemilla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PAgricola.CrySalSemilla.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrySalSemilla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrySalSemilla = New CrySalSemilla()
        rpt.Site = Me.Site
        Return rpt
    End Function
