...
Public Class CrySalidaSemilla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OPSystem.CrySalidaSemilla.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrySalidaSemilla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrySalidaSemilla = New CrySalidaSemilla()
        rpt.Site = Me.Site
        Return rpt
    End Function
