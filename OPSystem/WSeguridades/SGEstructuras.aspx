<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="SGEstructuras.aspx.vb" Inherits="OPSystem.SGEstructuras" %>
        ...
        <asp:Panel ID="pnlListar" runat="server">
            <table style="width:100%;">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="EstructuraMenuID" Font-Size="XX-Small" ForeColor="#333333" GridLines="None" ShowFooter="True" AllowPaging="True" CssClass="table table-condensed">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                            <Columns>
                                <asp:BoundField DataField="EstructuraMenuID" HeaderText="ID" />
                                <asp:BoundField DataField="EstructuraMenu" HeaderText="Estructura" />
