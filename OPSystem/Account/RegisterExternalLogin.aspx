<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="OPSystem.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="OPSystem" %>
