...
Public Class FletesAdmin
    ...
    Private Sub Fletes_Init(sender As Object, e As EventArgs) Handles Me.Init
        oUsr = Session("Usr")
        Dim user As String
        user = ValidaUser() 'Validación mediante la tabla TipoFleteUser
    ...
    Private Sub LoadLista()
        ...
        Try
            ...
            Dim oTabla As DataTable = oSql._List(oSql.ListaFleteAdmin, "FLETELISTA", oCs)
    ...
    Private Sub BarEventos3_MsgEvent(sAcción As String) Handles BarEventos3.MsgEvent
        Select Case sAcción
            Case Else
                Response.Redirect("FletesAdmin.aspx", True)
        End Select
    End Sub
